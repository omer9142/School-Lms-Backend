...
const { 
  sclassCreate, sclassList, deleteSclass, deleteSclasses, getSclassDetail, getSclassStudents, removeStudentFromClass 
...
const { 
  subjectCreate, classSubjects, deleteSubjectsByClass, getSubjectDetail, deleteSubject, freeSubjectList, allSubjects, deleteSubjects, deleteAllSubjects
} = require('../controllers/subject-controller.js');

const { 
  teacherRegister, teacherLogIn, getTeachers,
   getTeacherDetail, deleteTeachersByClass, 
   deleteTeacher, updateTeacherSubject,
    teacherAttendance, assignTeacherToClass, 
    updateTeacher ,assignClassTeacher, 
    removeTeacherSubject, removeClassTeacher
...
const { addMarks, getTeacherMarks, getStudentMarks, getSubjectMarks , updateMarks , deleteMarks, getMarksByStudent } = require('../controllers/marksController.js');
...
router.get('/students/unassigned/:schoolId', getUnassignedStudents);

// ✅ Assign an unassigned student to a class
router.put('/sclass/:classId/assign-student/:studentId', assignStudentToClass);
...
router.put("/remove-subject", removeTeacherSubject);
router.put("/remove-class-teacher", removeClassTeacher);
...
router.put('/updateComplain/:id', updateComplainStatus);
router.put('/updateMultipleComplains', updateMultipleComplainsStatus);
router.delete('/deleteComplain/:id', deleteComplain);
router.delete('/deleteComplains/:id', deleteComplains);
...
router.put(
  "/Sclass/:classId/RemoveStudent/:studentId",
  removeStudentFromClass
);

// Remove all students from a class
router.put('/sclass/:classId/RemoveAllStudents', removeAllStudentsFromClass);


router.delete("/Sclass/:classId/Subjects", deleteAllSubjects);
// Subject
